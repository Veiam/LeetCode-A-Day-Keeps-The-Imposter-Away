...
console.log(`Roots of MHTs: ${find_trees(5, [[0, 1], [1, 2], [1, 3], [2, 4]])}`)
console.log(`Roots of MHTs: ${find_trees(4, [[0, 1], [0, 2], [2, 3]])}`)
console.log(`Roots of MHTs: ${find_trees(4, [[1, 2], [1, 3]])}`)
