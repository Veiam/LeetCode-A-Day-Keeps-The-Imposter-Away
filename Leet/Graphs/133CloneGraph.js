 ...
 * @param {Node} node
 * @return {Node}
 * Time Compleixty: O(n + m), where n is number of node and m is number of unique relationships
 * Space Compleixty: O(n + h), where n is nodes in visited and h is recursion stack 
 */
